  ...
  Therefore, we expect bullets to arrive as a beam.
   ...
   \end{figure}
     ...
     The maximum intensity (square of max amplitude) will be observed at the hole.
        ...
        The obtained pattern has alternating minima and maxima and it can be
        seen that $P_{12} \neq P_1+P_2$. Consider the $P$s as the intensities of
        the waves, and $A$ as the amplitudes.
        ...
        \begin{align*}
          A_{12} = A_1+A_2\rightarrow P_{12} &= |A_1+A_2|^2=\\
...
It would be expected that, irregardless of the frequency or wave-length, the amount of electron extracted would scale with the intensity of the electromagnetic wave.
  ...
  If $\nu>\nu_{\min}$, the amount of electrons scales with the intensity. Also,
  the velocity of those electrons, extracted, would depend on the difference
  between $\nu - \nu_{min}$.
...
\end{figure}
  ...
  This led to the introduction of two pivotal concepts of modern physics.
    ...
    Light is made by the photon particle which carries energy $E = h\nu$, where $\omega = 2\pi\nu$ and $\hbar = \frac{h}{2\pi}$, so:
...
\section{Stern Gerlach experiment}
  ...
  \begin{figure}[ht]
    ...
    \centering
    \includegraphics[width=0.6\textwidth]{sterngerlach.PNG}
    \label{fig: }
  \end{figure}
